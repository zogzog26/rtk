...
pub enum AgentTarget {
    ...
    Cline,
    /// badlogic/pi-mono (Mario Zechner's coding agent)
    PiMono,
}
    ...
    match cli.command {
        ...
        Commands::Init {
            ...
            if show {
                ...
                let pi_mono = agent == Some(AgentTarget::PiMono);
                init::uninstall(global, gemini, codex, cursor, pi_mono, cli.verbose)?;
            } else if gemini {
                ...
                let install_pi_mono = agent == Some(AgentTarget::PiMono);
